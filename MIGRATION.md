...
8. `ledger` - SPEC-002 ledger operations
...
**Key Challenges**:
- Web framework migration (FastAPI → Axum)
- Async runtime setup (uvicorn → tokio)
- Type-safe request/response models (Pydantic → serde)
- State management with Send+Sync constraints
- API compatibility with migrated MEF crates
- Complex endpoint signatures and data flow
